        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalMessage}>
              To add drivers and manage your fleet, please complete your KYC.
            </Text>
      ...
      <ScrollView style={styles.container}>
          ...
          <View style={styles.grid}>
            ...
            <TouchableOpacity
              ...
              <MaterialCommunityIcons
                ...
                style={styles.gridIcon}
              />
              <Text style={styles.gridBtnText}>Add Driver</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.emptyBox}>
          <Image
            ...
            resizeMode="contain"
          />
          <Text style={styles.emptyText}>NO DRIVERS HAVE BEEN ADDED YET</Text>
        </View>

        <View style={styles.routesContainer}>
          <Text style={styles.routesTitle}>Operating Routes</Text>
